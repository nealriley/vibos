 ...
 * Default Template
 * 
 * The original VibeOS chat interface with:
 * - Dark theme (zinc-based)
 * - Violet accent colors
 * - Motion animations
 * - Message feed with thinking indicator
 */
...
export const info: TemplateInfo = {
  id: 'default',
  name: 'Default',
  description: 'The original VibeOS interface with dark theme and animations',
  author: 'VibeOS',
  version: '1.0.0',
}
